sap.ui.define(
  ...
  function (Controller, MessageBox, Fragment) {
    ...
    return Controller.extend("sap.ui.demo.walkthrough.controller.App", {
       ...
       * @param {sap.ui.base.Event} oEvent
       */
      onConcodeComboBoxChange: function (oEvent) {
       ...
       * @param {sap.ui.base.Event} oEvent
       */
      onConresnComboBoxChange: function (oEvent) {
        const oViewModel = this.getView().getModel();
       ...
       * @param {sap.ui.base.Event} oEvent
       */
      onButtonDetailPress: async function (oEvent) {
        const oViewModel = this.getView().getModel();
       ...
       *
       */
      onButtonLessPress: function () {
        const oViewModel = this.getView().getModel();
        const oBundle = this.getView().getModel("i18n").getResourceBundle();
        const oTable = this.byId("idRelationTable");
